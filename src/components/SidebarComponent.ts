...
export class SidebarComponent extends BaseComponent {
  ...
  render(): string {
    ...
    return `
      <aside class="w-full lg:w-[40%] flex-shrink-0 bg-gradient-to-r from-violet-200 to-orange-50 to-107% py-10 sm:py-12 lg:py-20 px-6 sm:px-10 lg:px-16 flex flex-col lg:h-screen">
